...
public class VibrationController : MonoBehaviour
{
    ...
    public float vibrationPower = -1;//in awake is power and time vibration
    public Slider vibrationTimeSlider;
    public Slider vibrationTimeSlider2;
    public Text textSetValue;
    public Text textSetValue2;

    public void TestVibration()
    {
        vibrationTime = vibrationTimeSlider.value * 20;

        if (vibrationTimeSlider2.value == 0)
        {

        }
        else
        {
            vibrationPower = vibrationTimeSlider2.value * 255;
        }
        
        textSetValue.text = vibrationTimeSlider.value.ToString();
        textSetValue2.text = vibrationTimeSlider2.value.ToString();
        Vibrate();
    }
    ...
    public void Awake()
    {
        vibrationTime = 0.6478f * 20;
        vibrationPower = 1f * 255;

        Button[] dontDestroyButtons = FindObjectsOfType<Button>(true);
        //Debug.LogError("------dontDestroyButtons length " + dontDestroyButtons.Length);
        foreach (Button button in dontDestroyButtons)
        {
    ...
    {
        Debug.Log("Button was clicked and vibration on!");
        Vibrate();
    }
    ...
    public void Vibrate()
    {
        ...
        {
            Vibration.Vibrate((long)vibrationTime, (int)vibrationPower);
        }
    }
}
